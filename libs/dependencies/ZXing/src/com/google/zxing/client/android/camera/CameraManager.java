...
public final class CameraManager {
	...
	public synchronized void openDriver(SurfaceHolder holder)
		...
		theCamera.setDisplayOrientation(90); // Rotate camera to upright in portrait
				
		configManager.setScreenResolution(holder.getSurfaceFrame().width(), holder.getSurfaceFrame().height());
		Log.d(TAG,holder.getSurfaceFrame().width()+ " "+ holder.getSurfaceFrame().height());		
	...
	public synchronized Rect getFramingRectInPreview() {
		if (framingRectInPreview == null) {
			...
			if (false) {
				...
				// Adjust frame dimensions to portrait.
				// greg				
	...
	/**
	 * Returns instance of CameraConfigurationManager.
	 */
