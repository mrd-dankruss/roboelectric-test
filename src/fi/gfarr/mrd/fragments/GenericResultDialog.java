...
public class GenericResultDialog extends DialogFragment
{
    private int mNum;
     ...
     * as an argument.
     */
    public static GenericResultDialog newInstance(int num) {
    	GenericResultDialog f = new GenericResultDialog();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        temp.add(new DialogDataObject("5 min", "5 min"));
        temp.add(new DialogDataObject("10 min", "10 min"));
        temp.add(new DialogDataObject("20 min", "20 min"));
        temp.add(new DialogDataObject("30 min", "30 min"));
        temp.add(new DialogDataObject("1 hour", "1 hour"));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lv.setOnItemClickListener(new OnItemClickListener()
		{
			...
			{
				getActivity().getIntent().putExtra(DIALOG_TIME_STRING, temp.get(position).getShortDisplayTime());
